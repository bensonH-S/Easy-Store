...
public class ControleVenda {
    ...
    public void fechaVenda(ModeloVenda mod){
     ...
     conecta.conexao();
        try {
            PreparedStatement pst = conecta.conn.prepareStatement("UPDATE venda SET data_venda = ?, valor_venda = ?,  tipo_pagamento = ?, id_caixa = ?, vendedor = ?, status = ? WHERE id_venda = ?");
            ...
            pst.setString(5, mod.getVendedor());
